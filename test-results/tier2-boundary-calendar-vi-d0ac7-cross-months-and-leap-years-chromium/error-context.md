...
- Name: tier2-boundary\calendar-views.spec.ts >> Calendar 5-Views UI - Boundary & Corner Cases >> should correctly display multi-day events that span across months and leap years
- Location: e2e\tests\tier2-boundary\calendar-views.spec.ts:13:3
...
Locator: locator('text=Leap Year Event')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Leap Year Event')
