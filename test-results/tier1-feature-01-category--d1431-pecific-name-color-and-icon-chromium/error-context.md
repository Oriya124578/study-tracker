...
- Name: tier1-feature\01-category-management.spec.ts >> Category Management >> should create a new category with a specific name, color, and icon
- Location: e2e\tests\tier1-feature\01-category-management.spec.ts:4:3
...
Call log:
  - waiting for getByRole('button', { name: 'Add Category' })
