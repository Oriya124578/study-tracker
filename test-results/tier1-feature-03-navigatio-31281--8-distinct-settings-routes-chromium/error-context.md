...
- Name: tier1-feature\03-navigation-settings.spec.ts >> Navigation & Settings Routes >> should navigate successfully to all 8 distinct settings routes
- Location: e2e\tests\tier1-feature\03-navigation-settings.spec.ts:4:3
