...
- Name: tier2-boundary\google-calendar.spec.ts >> Google Calendar Integration - Boundary & Corner Cases >> should correctly handle syncing an event with an extremely long title and description
- Location: e2e\tests\tier2-boundary\google-calendar.spec.ts:13:3
...
Call log:
  - waiting for locator('button:has-text("New Event")')
