...
- Name: tier2-boundary\category-assignment.spec.ts >> Assign Categories to Tasks - Boundary & Corner Cases >> should handle assigning the maximum allowed number of categories to a single task
- Location: e2e\tests\tier2-boundary\category-assignment.spec.ts:8:3
