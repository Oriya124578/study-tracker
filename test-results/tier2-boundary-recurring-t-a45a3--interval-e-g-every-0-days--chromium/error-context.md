...
- Name: tier2-boundary\recurring-tasks.spec.ts >> Recurring Tasks - Boundary & Corner Cases >> should prevent creating a recurring task with zero interval (e.g., every 0 days)
- Location: e2e\tests\tier2-boundary\recurring-tasks.spec.ts:30:3
...
Call log:
  - waiting for locator('button:has-text("New Recurring Task")')
