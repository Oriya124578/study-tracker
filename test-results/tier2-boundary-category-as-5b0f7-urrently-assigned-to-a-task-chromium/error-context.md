...
- Name: tier2-boundary\category-assignment.spec.ts >> Assign Categories to Tasks - Boundary & Corner Cases >> should correctly handle deleting a category that is currently assigned to a task
- Location: e2e\tests\tier2-boundary\category-assignment.spec.ts:21:3
...
Call log:
  - waiting for locator('button[aria-label="Delete AssignedCategory"]')
