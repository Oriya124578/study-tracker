...
- Name: tier1-feature\05-google-calendar.spec.ts >> Google Calendar Integration >> should securely handle the OAuth callback and update the connection state
- Location: e2e\tests\tier1-feature\05-google-calendar.spec.ts:19:3
...
Locator: getByText('Calendar Connected')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Calendar Connected')
