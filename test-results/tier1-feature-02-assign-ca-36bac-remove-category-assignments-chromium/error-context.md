...
- Name: tier1-feature\02-assign-categories.spec.ts >> Assign Categories to Tasks >> should update a task to add or remove category assignments
- Location: e2e\tests\tier1-feature\02-assign-categories.spec.ts:17:3
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'Existing Task' })
