...
- Name: tier2-boundary\google-calendar.spec.ts >> Google Calendar Integration - Boundary & Corner Cases >> should handle simultaneous offline creation of events and conflicting Google Calendar sync
- Location: e2e\tests\tier2-boundary\google-calendar.spec.ts:36:3

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at http://localhost:5173/calendar
Call log:
  - navigating to "http://localhost:5173/calendar", waiting until "load"
