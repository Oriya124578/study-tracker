...
- Name: tier1-feature\02-assign-categories.spec.ts >> Assign Categories to Tasks >> should handle tasks with multiple categories assigned correctly
- Location: e2e\tests\tier1-feature\02-assign-categories.spec.ts:45:3
