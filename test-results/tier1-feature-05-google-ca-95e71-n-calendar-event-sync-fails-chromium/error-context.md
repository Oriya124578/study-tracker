...
- Name: tier1-feature\05-google-calendar.spec.ts >> Google Calendar Integration >> should gracefully display an error state when calendar event sync fails
- Location: e2e\tests\tier1-feature\05-google-calendar.spec.ts:38:3
...
Call log:
  - waiting for getByRole('button', { name: 'Sync Now' })
