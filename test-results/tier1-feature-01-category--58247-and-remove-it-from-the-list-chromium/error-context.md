...
- Name: tier1-feature\01-category-management.spec.ts >> Category Management >> should delete a category and remove it from the list
- Location: e2e\tests\tier1-feature\01-category-management.spec.ts:35:3
...
Call log:
  - waiting for getByRole('listitem').filter({ hasText: 'To Delete' }).getByRole('button', { name: 'Delete' })
