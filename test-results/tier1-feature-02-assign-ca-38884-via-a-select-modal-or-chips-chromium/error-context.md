...
- Name: tier1-feature\02-assign-categories.spec.ts >> Assign Categories to Tasks >> should allow assigning an existing category to a new task via a select modal or chips
- Location: e2e\tests\tier1-feature\02-assign-categories.spec.ts:4:3
