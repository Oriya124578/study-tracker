...
- Name: tier1-feature\03-navigation-settings.spec.ts >> Navigation & Settings Routes >> should display the correct UI components and header wordmark for each settings route
- Location: e2e\tests\tier1-feature\03-navigation-settings.spec.ts:16:3
...
Locator: getByText('Calorie Life')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Calorie Life')
