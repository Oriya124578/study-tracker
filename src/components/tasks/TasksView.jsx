    ...
    >
      ...
      <div className="mx-4 mt-4 mb-3 flex items-center gap-3 px-4 py-3 rounded-2xl border border-border bg-card shadow-sm">
        <button
          ...
          className="shrink-0 w-6 h-6 rounded-full border-2 border-primary flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"
        >
      ...
      {completedTasks.length > 0 && (
        <div className="mx-4 mt-3 rounded-2xl border border-border bg-card overflow-hidden mb-2">
          <button
            ...
            className="w-full flex items-center gap-2 px-4 py-3.5 text-sm font-semibold text-muted-foreground hover:bg-muted/50 transition-colors"
            dir={isRTL ? 'rtl' : 'ltr'}
          >
            <motion.div
